...
type ShunDriver struct { //司机信息
	...
	IdCardNo                string    `gorm:"column:id_card_no;type:char(18);comment:身份证号;not null;" json:"id_card_no"`                                        // 身份证号
	IdCardFrontUrl          string    `gorm:"column:id_card_front_url;type:varchar(255);comment:身份证正面URL;not null;" json:"id_card_front_url"`                  // 身份证正面URL
	IdCardBackUrl           string    `gorm:"column:id_card_back_url;type:varchar(255);comment:身份证反面URL;not null;" json:"id_card_back_url"`                    // 身份证反面URL
	...
	DriverLicenseUrl        string    `gorm:"column:driver_license_url;type:varchar(255);comment:驾驶证URL;not null;" json:"driver_license_url"`                  // 驾驶证URL
	...
	HealthCertUrl           string    `gorm:"column:health_cert_url;type:varchar(255);comment:体检报告URL;default:NULL;" json:"health_cert_url"`                   // 体检报告URL
	ResidencePermitUrl      string    `gorm:"column:residence_permit_url;type:varchar(255);comment:居住证URL;default:NULL;" json:"residence_permit_url"`          // 居住证URL
